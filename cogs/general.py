...
class General(commands.Cog):
    ...
    async def botinfo(self, ctx):
        ...
        embed = discord.Embed(
            ...
            description="A custom bot for managing the Fck Society Minecraft server"
        )
    ...
    async def help_command(self, ctx):
        ...
        embed.add_field(name="📋 Minecraft Commands", value=minecraft_commands, inline=False)
        embed.add_field(name="🔊 Voice Channel Commands", value=voice_commands, inline=False)
        ...
        embed.set_footer(text="Admin commands can only be used in the cPanel channel by users with Admin/Moderator roles")
